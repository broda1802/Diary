...
urlpatterns = [
    ...
    path('update_patient_diseases/<int:pk>/', views.PatientDiseaseDetailView.as_view(), name='patient_disease_detail_view'),
    ...
    path('delete_patient_disease/<int:pk>/', views.DeletePatientDiseaseView.as_view(), name='patient_disease_delete_view'),
    ...
    path('update_patient_disease/<int:pk>/', views.UpdatePatientDiseaseView.as_view(), name='update_patient_disease_view'),
