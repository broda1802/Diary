...
urlpatterns = [
    ...
    path('update_patient_diseases/<int:pk>/', views.PatientDiseaseDetailView.as_view(),
         name='patient_disease_detail_view'),
    path('update_patient_drug/<int:pk>/', views.PatientDrugDetailView.as_view(), name='patient_drug_detail_view'),
    ...
    path('add_patient_disease/', views.AddPatientDiseaseView.as_view(), name='patient_disease_add_view'),
    path('add_patient_drug/', views.AddPatientDrugView.as_view(), name='patient_drug_add_view'),
    ...
    path('delete_patient_disease/<int:pk>/', views.DeletePatientDiseaseView.as_view(),
         name='patient_disease_delete_view'),
    path('delete_patient_drug/<int:pk>/', views.DeletePatientDrugView.as_view(), name='patient_drug_delete_view'),
    ...
    path('update_patient_disease/<int:pk>/', views.UpdatePatientDiseaseView.as_view(),
         name='update_patient_disease_view'),
    path('update_patient_drug/<int:pk>/', views.UpdatePatientDrugView.as_view(),
         name='update_patient_drug_view'),
