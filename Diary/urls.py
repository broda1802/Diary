...
urlpatterns = [
    ...
    path('patient_diseases/<int:pk>/', views.PatientDiseaseDetailView.as_view(),
         name='patient_disease_detail_view'),
    path('patient_drug/<int:pk>/', views.PatientDrugDetailView.as_view(), name='patient_drug_detail_view'),
    ...
    path('detail_patient_drug/<int:pk>/', views.DetailPatientDrugView.as_view(),
         name='detail_patient_drug_view'),
